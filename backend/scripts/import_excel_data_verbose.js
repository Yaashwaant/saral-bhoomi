...
async function importExcelData() {
  try {
    ...
    if (!project) {
      console.log('📁 Creating new Chandrapada Project...');
      ...
      console.log('📁 Found existing Chandrapada Project:', project.name);
    }
    
    // Read Excel file
    const excelFilePath = path.join(__dirname, '../../Chandrapada New 20.01.23-.xlsx');
    console.log('📂 Checking Excel file path:', excelFilePath);
